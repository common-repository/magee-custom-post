<?php
/*
  Plugin Name: Magee Custom Post
  Plugin URI: http://www.mageewp.com/
  Description: Magee custom post.
  Version: 1.0.4
  Author: MageeWP
  Author URI: http://www.mageewp.com
  Text Domain: mcp-custom-post
...
class Mcp_Post{
	...
	public static function init() {
	   ...
	   load_plugin_textdomain( 'mcp-custom-post', false,  dirname( plugin_basename(  __FILE__  ) )  . '/languages/'  );
   ...
   public static  function admin_scripts() {
	  ...
	  wp_enqueue_style( 'mcp-post-admin',  plugins_url( 'assets/css/admin.css',__FILE__ ), '','1.0.0', false );
	//  wp_enqueue_script( 'bootstrap',  plugins_url( 'assets/plugins/bootstrap/js/bootstrap.min.js',__FILE__ ), array( 'jquery'),'3.3.7', true );
	  wp_enqueue_script( 'fontawesome-iconpicker',  plugins_url( 'assets/plugins/fontawesome-iconpicker/js/fontawesome-iconpicker.js',__FILE__ ), array( 'jquery'),'1.0.0', true );
	   ...
	   wp_enqueue_script( 'mcp-post-admin',  plugins_url( 'assets/js/admin.js',__FILE__ ), array( 'jquery'),'1.0.0', true );
   ...
   public static  function frontend_scripts() {	
      ...
      wp_enqueue_style('font-awesome',  plugins_url( 'assets/plugins/font-awesome/css/font-awesome.min.css', __FILE__  ), '', '4.6.3', false );
	  wp_enqueue_script( 'bootstrap',  plugins_url( 'assets/plugins/bootstrap/js/bootstrap.min.js',__FILE__ ), array( 'jquery'),'3.3.7', true );
      wp_enqueue_script( 'mcp-post-main',  plugins_url( 'assets/js/main.js',__FILE__ ), array( 'jquery'),'1.0.0', true );
	  wp_localize_script( 'mcp-post-main', 'mcp_post_params', array(
